...
static void gst_native_init (JNIEnv* env, jobject thiz) {
  ...
  LOGD_CATEGORY_INIT (debug_category, "tutorial-3", 0, "Android tutorial 3");
  LOGD_set_threshold_for_name("tutorial-3", GST_LEVEL_DEBUG);
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
  ...
  jclass klass = (*env)->FindClass (env, "com/pfg/gstreamerandroid/Tutorial3");
